...
HYPOTHESES = {
    ...
    "var_mod": "When comparing studies where {iv_label} is {cat_t1_label} and studies where {iv_label} is {cat_t2_label}, {dependent} from studies involving {mod_t1_label} as {mod_label} are significantly {comparative} than {dependent} from studies involving {mod_t2_label} as {mod_label}.",
...
NE_HYPOTHESES = {
    ...
    "var_mod": "When comparing studies where {iv_label} is {cat_t1_label} and studies where {iv_label} is {cat_t2_label}, there is no significant differences in {dependent} between studies involving {mod_t1_label} as {mod_label} and studies involving {mod_t2_label} as {mod_label}.",
    "study_mod": "When comparing studies where {iv_label} is {cat_t1_label} and studies where {iv_label} is {cat_t2_label}, there is no significant difference in {dependent} when {mod_label} is {mod_val_label} compared to when {mod_label} has another value.",
}
